...
- Principled approach? [VanderWeele et al. 2019](https://doi.org/10.1007/s10654-019-00494-6) EJE
]
...
- Primarily to deal with .red[residual confounding]
  ...
  - Motivation of PS and hdPS are different to begin
...
.center[.red[I prefer to use hdPS / ML with ECs as a **sensitivity analysis**.]]

---

class: inverse, center, middle

# Other / newer research directions
...
Weberpals et al. (2021) proposed to use autoencoders (3, 5, 7 layers) to reduce EC
dimensions.
...
SL, TMLE, AIPW and usefulness of cross-validation 
...
- Opportunity to conduct more research in this area
]
