...
institute: "2022 Sentinel Innovation and Methods Seminar Series"
date: "May 11, 2022"
output:
...
knitr::include_graphics('images/top0.png')
```
```{r echo=FALSE, out.width='100%', fig.align="center"}
...
.center[Slides at [tinyurl.com/hdps2022](https://tinyurl.com/hdps2022)]
...
.red[Healthcare claims data] for immigrants to British Columbia, Canada, 1985–2015
...
.center[.red[**Only ~ 30% of the selected ECs were common.**]]
...
.red[Answer] to the question in the title of this talk (**bold** = pure ML):
